    ...
    <main>
        <div class="container">
            <form class="row g-3" method="get">        
                <div class="col-3">
                    <label for="lbBase" class="form-label">Base:</label>
                    <input type="text" class="form-control" placeholder="Digite o valor da base..." name="txtBase">
                </div>
                <div class="col-3">
                    <label for="lbNota1" class="form-label">Altura:</label>
                    <input type="text" class="form-control" placeholder="Digite o valor da altura..." name="txtAltura">
                </div>
                <div class="col-12">
